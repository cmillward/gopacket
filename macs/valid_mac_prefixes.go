...
// Generated at 2014-02-13 10:35:26.194256328 -0700 MST
...
var validMACPrefixMap = map[[3]byte]string{
	...
	[3]byte{0, 0, 100}:     "YOKOGAWA DIGITAL COMPUTER CORP",
	...
	[3]byte{0, 1, 173}:     "Coach Main International  d.b.a. CMI Worldwide, Inc.",
	[3]byte{0, 1, 174}:     "Trex Enterprises",
	[3]byte{0, 1, 175}:     "Emerson Network Power",
	...
	[3]byte{0, 3, 1}:       "Avantas Networks Corporation",
	...
	[3]byte{0, 6, 11}:      "Emerson Network Power",
	...
	[3]byte{0, 8, 249}:     "Emerson Network Power",
	...
	[3]byte{0, 10, 48}:     "Johnson Controls-ASG",
	...
	[3]byte{0, 12, 178}:    "Comstar Co., Ltd.",
	...
	[3]byte{0, 12, 189}:    "Interface Mains, Inc",
	...
	[3]byte{0, 13, 2}:      "NEC AccessTechnica, Ltd.",
	...
	[3]byte{0, 14, 102}:    "Hitachi Advanced Digital, Inc.",
	...
	[3]byte{0, 14, 226}:    "Custom Engineering S.p.A.",
	...
	[3]byte{0, 16, 94}:     "HEKIMIAN LABORATORIES, INC.",
	...
	[3]byte{0, 19, 235}:    "Sysmain Corporation",
	...
	[3]byte{0, 21, 157}:    "Minicom Advanced Systems ltd",
	...
	[3]byte{0, 27, 139}:    "NEC AccessTechnica, Ltd.",
	...
	[3]byte{0, 28, 21}:     "TXP Corporation",
	...
	[3]byte{0, 28, 117}:    "RF Systems GmbH",
	...
	[3]byte{0, 30, 108}:    "Carbon Mountain LLC",
	...
	[3]byte{0, 30, 200}:    "2Wire, Inc.",
	[3]byte{0, 30, 201}:    "2Wire, Inc.",
	[3]byte{0, 30, 202}:    "2Wire, Inc.",
	[3]byte{0, 30, 203}:    "2Wire, Inc.",
	[3]byte{0, 30, 204}:    "2Wire, Inc.",
	[3]byte{0, 30, 205}:    "KYLAND Technology Co. LTD",
	[3]byte{0, 30, 206}:    "2Wire, Inc.",
	[3]byte{0, 30, 207}:    "2Wire, Inc.",
	[3]byte{0, 30, 208}:    "2Wire, Inc.",
	[3]byte{0, 30, 209}:    "2Wire, Inc.",
	[3]byte{0, 30, 210}:    "2Wire, Inc.",
	[3]byte{0, 30, 211}:    "2Wire, Inc.",
	[3]byte{0, 30, 212}:    "2Wire, Inc.",
	[3]byte{0, 30, 213}:    "2Wire, Inc.",
	[3]byte{0, 30, 214}:    "2Wire, Inc.",
	[3]byte{0, 30, 215}:    "2Wire, Inc.",
	[3]byte{0, 30, 216}:    "2Wire, Inc.",
	[3]byte{0, 30, 217}:    "2Wire, Inc.",
	[3]byte{0, 30, 218}:    "2Wire, Inc.",
	[3]byte{0, 30, 219}:    "2Wire, Inc.",
	[3]byte{0, 30, 220}:    "2Wire, Inc.",
	[3]byte{0, 30, 221}:    "2Wire, Inc.",
	[3]byte{0, 30, 222}:    "2Wire, Inc.",
	[3]byte{0, 30, 223}:    "2Wire, Inc.",
	...
	[3]byte{0, 32, 133}:    "EXIDE ELECTRONICS",
	...
	[3]byte{0, 58, 157}:    "NEC AccessTechnica, Ltd.",
	...
	[3]byte{0, 80, 249}:    "SENSORMATIC ACD",
	...
	[3]byte{0, 96, 96}:     "DAWNING TECHNOLOGIES, INC.",
	...
	[3]byte{0, 96, 185}:    "NEC Infrontia Corporation",
	...
	[3]byte{0, 128, 66}:    "Emerson Network Power",
	...
	[3]byte{0, 192, 249}:   "Emerson Network Power",
	...
	[3]byte{0, 224, 53}:    "Emerson Network Power",
	...
	[3]byte{12, 217, 193}:  "Johnson Controls-ASG",
	...
	[3]byte{16, 102, 130}:  "NEC AccessTechnica, Ltd.",
	...
	[3]byte{24, 208, 113}:  "DASAN SMC, Inc.",
	...
	[3]byte{28, 177, 127}:  "NEC AccessTechnica, Ltd.",
	...
	[3]byte{116, 143, 27}:  "MainImage 3D",
	...
	[3]byte{136, 92, 79}:   "Alcatel Lucent",
	...
	[3]byte{160, 115, 50}:  "Cashmain International Limited",
	...
	[3]byte{164, 44, 8}:    "Mainwork Automodules",
	...
	[3]byte{164, 216, 86}:  "Qualcomm Labs Inc.",
	...
	[3]byte{212, 92, 112}:  "Wireless Gigabit Alliance",
	...
	[3]byte{216, 151, 59}:  "Emerson Network Power Embedded Power",
	...
	[3]byte{216, 231, 43}:  "OnPATH Technologies",
	...
	[3]byte{236, 158, 205}: "Emerson Network Power and Embedded Computing",
	...
	[3]byte{244, 179, 129}: "WindowMain A/S",
	...
	[3]byte{252, 68, 99}:   "Universal Audio",
